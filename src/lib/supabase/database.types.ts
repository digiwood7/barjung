...
export type PlatformName = "naver" | "instagram" | "daangn" | "zigbang" | "tiktok" | "youtube";
...
export interface Database {
  public: {
    Tables: {
      ...
      runner_commands: { Row: Row<{ command: "naver_login" | "instagram_login" | "daangn_login"; status: "queued" | "running" | "succeeded" | "failed"; result_message: string | null; lease_agent_id: string | null; lease_expires_at: string | null; started_at: string | null; completed_at: string | null; updated_at: string }> };
    };
